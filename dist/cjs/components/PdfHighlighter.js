        ...
        this.viewer =
            this.viewer ||
                new pdf_viewer_1.PDFViewer({
                    ...
                    findController: new pdf_viewer_1.PDFFindController({
                        eventBus: this.eventBus,
                        linkService: this.linkService,
                    }),
                    renderer: "canvas",
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { onPointerDown: this.onMouseDown },
            react_1.default.createElement("div", { ref: this.containerNodeRef, className: "PdfHighlighter", onContextMenu: (e) => e.preventDefault() },
                ...
                this.renderTip(),
                typeof enableAreaSelection === "function" ? (react_1.default.createElement(MouseSelection_1.default, { onDragStart: () => this.toggleTextSelection(true), onDragEnd: () => this.toggleTextSelection(false), onChange: (isVisible) => this.setState({ isAreaSelectionInProgress: isVisible }), shouldStart: (event) => {
                        return ((this.state.forceAreaHighlight ||
                            enableAreaSelection(event)) &&
                            (0, pdfjs_dom_1.isHTMLElement)(event.target) &&
                            Boolean((0, pdfjs_dom_1.asElement)(event.target).closest(".page")));
